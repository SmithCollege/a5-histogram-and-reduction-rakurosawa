...
int cpuMaxReduct(float* arr, char* opperation){
    if (opperation == "max"){
        float max = arr[0];
...
int main() {
    ...
    printf("max value in arr is: %d\n", cpuMaxReduct(small_test_arr, "max"));
    printf("min value in arr is: %d\n", cpuMaxReduct(small_test_arr, "min"));
    printf("sum of arr is: %d\n", cpuMaxReduct(small_test_arr, "sum"));
    printf("product of arr is: %d\n", cpuMaxReduct(small_test_arr, "product"));
