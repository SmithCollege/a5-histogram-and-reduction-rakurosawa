...
int main(){
    ...
    lessThdDiv<<<NUM_THDS/BLOCK_SIZE, BLOCK_SIZE>>>(input, 'x');
    ...
    lessThdDiv<<<NUM_THDS/BLOCK_SIZE, BLOCK_SIZE>>>(input, 'n');
    cudaDeviceSynchronize();
    ...
    lessThdDiv<<<NUM_THDS/BLOCK_SIZE, BLOCK_SIZE>>>(input, 's');
    cudaDeviceSynchronize();
    ...
    lessThdDiv<<<NUM_THDS/BLOCK_SIZE, BLOCK_SIZE>>>(input, 'p');
    cudaDeviceSynchronize();
